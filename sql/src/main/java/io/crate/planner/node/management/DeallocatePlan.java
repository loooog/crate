...
public class DeallocatePlan implements Plan {

    @Nullable
    private final String prepStmtToDeallocate;

    public DeallocatePlan() {
        this.prepStmtToDeallocate = null;
    }

    public DeallocatePlan(String prepStmtToDeallocate) {
        this.prepStmtToDeallocate = prepStmtToDeallocate;
    }

    @Nullable
    public String prepStmtToDeallocate() {
        return prepStmtToDeallocate;
    }
